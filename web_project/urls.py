...
from dashboard.views import dashboard , dashboard_view, signup_view, settings_view, update_profile, update_notification, sales_chart_data, stock_chart_data, sales_line_chart_data
